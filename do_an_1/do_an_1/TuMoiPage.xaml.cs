...
namespace do_an_1
{
    ...
    public partial class TuMoiPage : ContentPage
    {
        ...
        async void LayDsTuDN(tumoi t)
        {
            ...
            var chuoi = await http.GetStringAsync("http://192.168.1.11/webapi/api/ServiceController/LayDsTuTheoTruyen?matruyen=" + t.matu.ToString());
            var dstu = JsonConvert.DeserializeObject<List<tumoi>>(chuoi);
